...
export const events = [
    ...
    {
		primary: "My First Pet",
		secondary: "I got a cute Netherland Dwarf Rabbit named <b>Oreo</b>.",
    ...
    // },
	{
		...
		secondary: "I have been promoted to Senior Developer at <b>Radley Associates</b>.",
		time: new Date("November 10, 2024"),
		image: "",
		icon: <WorkIcon className={styles.icon} />
    }
];
